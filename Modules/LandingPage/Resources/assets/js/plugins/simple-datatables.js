                ...
                bindEvents() {
                    ...
                    if (t.perPageSelect) {
                        ...
                        e && e.addEventListener("change", (() => {
                            t.perPage = parseInt(e.value, 50), this.update(), this.fixHeight(), this.emit("datatable.perpage", t.perPage)
                        }), !1)
                    }
                    ...
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            ...
                            if (this.activeHeadings.forEach(((i, a) => {
                                ...
                                this.dom.replaceChild(s, i), this.headerTable.tHead = i, this.headerTable.parentElement.style.paddingRight = `${this.headerTable.clientWidth - this.dom.clientWidth + parseInt(this.headerTable.parentElement.style.paddingRight || "0", 50)}px`, t.scrollHeight > t.clientHeight && (t.style.overflowY = "scroll")
                            }
                        } else {
                            t = [], s = e("thead");
                            const i = e("tr");
