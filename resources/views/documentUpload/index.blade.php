                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn">
                                            <a class="mx-3 btn bg-secondary btn-sm align-items-center" href="{{ $documentPath . '/' . $document->document }}" target="_blank"  data-bs-toggle="tooltip" data-bs-original-title="{{ __('Preview') }}">
