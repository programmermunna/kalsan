                                ...
                                <tr>
                                    ...
                                    <td class="Action">
                                        <div class="action-btn ">
                                            <a href="#" class="mx-3 bg-warning btn btn-sm align-items-center" data-url="{{ route('response.detail',$response->id) }}" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="{{__('View')}}" data-title="{{__('Response Detail')}}">
