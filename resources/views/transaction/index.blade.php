...
@section('action-btn')
    <div class="float-end">
        <a href="{{route('transaction.export')}}" data-bs-toggle="tooltip" title="{{__('Export')}}" class="btn btn-sm btn-secondary me-1">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <div class="d-flex flex-column">
                                    <small class="text-danger">
                                        <strong>Deposit:</strong> {{ \Auth::user()->priceFormat($account->dr) }}
                                    </small>
                                    <small class="text-success">
                                        <strong>Withdrawal:</strong> {{ \Auth::user()->priceFormat($account->cr) }}
                                    </small>


                                    <hr class="my-1">

                                    <p class="mb-0 font-weight-bold {{ $account->balance < 0 ? 'text-danger' : 'text-dark' }}">
                                        <strong>{{ __('Net Balance') }}:</strong> {{ \Auth::user()->priceFormat($account->balance) }}
                                    </p>
                                </div>
                            </div>
                        </div>
