                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($accounts as $index => $account)
                                <tr class="font-style">
                                    ...
                                    <td>{{  \Auth::user()->priceFormat($account->current_balance ?? 0)}}</td>
                                            ...
                                            <span>
                                                @if($account->holder_name != 'Cash')
                                                    ...
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 bg-info btn btn-sm align-items-center" data-url="{{ route('bank-account.edit', $account->id) }}" data-ajax-popup="true" title="{{__('Edit')}}" data-title="{{__('Edit Bank Account')}}"data-bs-toggle="tooltip"  data-size="lg"  data-original-title="{{__('Edit')}}">
