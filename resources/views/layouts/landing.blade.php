        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://codecanyon.net/item/Miftah System-all-in-one-business-erp-with-project-account-hrm-crm/33263435" class="btn btn-outline-light" target="_blank"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                ...
                <p class="text-body">Copyright © 2022 | Design By Miftah System</p>
            </div>
        </div>
    </div>
</section>
