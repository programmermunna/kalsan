...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ route('productservice.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-original-title="{{__('Create')}}" title="{{__('Create New Destination')}}" class="btn btn-sm btn-primary">
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tbody>
                            @foreach ($productServices as $index => $productService)
                                <tr class="font-style">
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    @if(Gate::check('edit product & service') || Gate::check('delete product & service'))
                                        <td class="Action">
                                            ...
                                            {{-- <div class="action-btn me-2">
                                                <a href="#" class="mx-3 bg-warning btn btn-sm align-items-center" data-url="{{ route('productservice.detail', $productService->id) }}"
                                            ...
                                            @can('edit product & service')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 bg-info btn btn-sm  align-items-center" data-url="{{ route('productservice.edit', $productService->id) }}" data-ajax-popup="true"  data-size="lg " data-bs-toggle="tooltip" title="{{__('Edit')}}"  data-title="{{__('Edit Product')}}">
