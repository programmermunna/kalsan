                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body px-0">
                                        ...
                                        <form id="setting-form" method="post" action="{{ route('template.setting') }}"enctype="multipart/form-data" class="needs-validation" novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body px-0">
                                        ...
                                        <form id="setting-form" method="post"
                                            action="{{ route('bill.template.setting') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
