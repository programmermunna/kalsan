                            ...
                            $.each(data, function (indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[6] == "UnPaid" && valueOfElement[7] != 0) {
                                    var clickToPaid =
                                        ...
                                        '/' + datePicker + '"  class="btn-sm btn btn-primary me-1" "data-bs-toggle="tooltip" title="{{__('Click To Paid')}}" data-original-title="{{__('Click To Paid')}}"><i class="ti ti-currency-dollar"></i></a> ';
