...
@push('script-page')
    <script>
        @if(\Auth::user()->can('show sales dashboard'))
        (function () {
            var chartBarOptions = {
                series: [
                    {
                ...
                <div class="col-xxl-7">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mt-1 mb-0">{{__('Bank Account Balance')}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @forelse($bankAccountDetail as $index => $bankAccount)

                                        <tr class="font-style">
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{$bankAccount->bank_name}}</td>
                                            <td>{{$bankAccount->holder_name}}</td>
                                            <td>{{\Auth::user()->priceFormat($bankAccount->balance)}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4">
