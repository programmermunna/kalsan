...
<div class="row mb-4 gy-4">
    <div class="col-xxl-4 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0">
            ...
            <div class="icon-wrp d-flex align-items-center justify-content-between gap-3">                   
                <div class="info-icon">
                ...
                <div class="card-label text-sm flex-1">
                    {{ __('Paid Users : ') }}
