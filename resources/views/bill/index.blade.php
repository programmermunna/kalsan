...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('bill.export') }}" class="btn btn-sm btn-secondary me-1" data-bs-toggle="tooltip" title="{{__('Export')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 month">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::text('bill_date', isset($_GET['bill_date'])?$_GET['bill_date']:null, array('class' => 'form-control month-btn','id'=>'pc-daterangepicker-1','readonly','placeholder'=>__('Bill Date'))) }}
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                @foreach ($bills->items() as $bill)
                                    <tr>
                                        ...
                                        <td>{{ Auth::user()->dateFormat($bill->due_date) }}</td>s
                                        <td>
                                            @if($bill->status == 0)
                                                ...
                                                <span>
                                                    ...
                                                    @can('edit bill')
                                                        @if ($bill->status != 3 && $bill->status != 4)
                                                            <div class="action-btn me-2">
                                                                <a href="{{ route('bill.edit',\Crypt::encrypt($bill->id)) }}" class="mx-3 bg-info btn btn-sm align-items-center" data-bs-toggle="tooltip" title="Edit" data-original-title="{{__('Edit')}}">
                                                    ...
                                                    <div class="action-btn">
                                                        ...
                                                        <a href="#" class="mx-3 bg-danger btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$bill->id}}').submit();">
