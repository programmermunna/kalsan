...
@section('content')
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('order_number', __('Invoice Number'), ['class' => 'form-label']) }}
        ...
        <div class="col-12">
            <h5 class=" d-inline-block mb-4">{{__('Expense List')}}</h5>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            <div class="all-button-box me-2">
                                <a href="#" data-repeater-create="" class="btn btn-primary" data-bs-toggle="modal" data-target="#add-bank">
                                    <i class="ti ti-plus"></i> {{__('Add Expense')}}
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::number('quantity', null, array('class' => 'form-control quantity', 'placeholder' => __('Qty'))) }}
                                        <span class="unit input-group-text bg-transparent"></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::number('price', null, array('class' => 'form-control price', 'placeholder' => __('Price'))) }}
                                        <span class="input-group-text bg-transparent">{{\Auth::user()->currencySymbol()}}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::number('discount', null, array('class' => 'form-control discount', 'placeholder' => __('Discount'))) }}
                                        <span class="input-group-text bg-transparent">{{\Auth::user()->currencySymbol()}}</span>
                                    </div>
                                </td>
                                {{-- <td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right"><strong>{{__('Sub Total')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right"><strong>{{__('Discount')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right" class="blue-text"><strong>{{__('Total Amount')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("bill.index")}}';" class="btn btn-secondary me-3">
