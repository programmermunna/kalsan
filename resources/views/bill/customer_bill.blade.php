                                ...
                                @if(!empty($vendor->billing_name))
                                    <div class="col">
                                        <small class="font-style">
                                            ...
                                            {{ !empty($vendor->billing_city) ? $vendor->billing_city : '' }}{{ !empty($vendor->billing_city) && (!empty($vendor->billing_state) || !empty($vendor->billing_country)) ? ', ' : '' }}
                                            {{ !empty($vendor->billing_state) ? $vendor->billing_state : '' }}{{ !empty($vendor->billing_state) && !empty($vendor->billing_country) ? ', ' : '' }}
