                ...
                <td>
                    ...
                    @if(!empty($vendor->billing_name))
                        <p>
                            ...
                            {{!empty($vendor->billing_city) ? $vendor->billing_city : ''}}{{!empty($vendor->billing_city) && !empty($vendor->billing_state) ? ', ' : ''}}{{!empty($vendor->billing_state) ? $vendor->billing_state : ''}}{{!empty($vendor->billing_zip) ? ', '.$vendor->billing_zip : ''}}<br>
