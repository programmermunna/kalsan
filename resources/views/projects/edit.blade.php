    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('project_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Name')]) }}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('budget', null, ['class' => 'form-control', 'placeholder' => __('Enter Budget')]) }}
            </div>
        </div>
        <div class="col-6 col-md-6">
            <div class="form-group">
                {{ Form::label('estimated_hrs', __('Estimated Hours'),['class' => 'form-label']) }}
                {{ Form::number('estimated_hrs', null, ['class' => 'form-control','min'=>'0','maxlength' => '8', 'placeholder' => __('Enter Estimated Hours')]) }}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('tag', isset($project->tags) ? $project->tags: '', ['class' => 'form-control', 'data-toggle' => 'tags', 'placeholder' => __('Enter Tags')]) }}
            </div>
        </div>
    </div>
    <div class="row">
