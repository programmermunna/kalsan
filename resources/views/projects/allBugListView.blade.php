...
@section('action-btn')
    <div class="float-end">
        ...
        @else
            <a href="{{ route('bugs.view', 'grid') }}" class="btn btn-primary btn-sm me-1" data-bs-toggle="tooltip" title="{{__('Card View')}}">
        ...
        @can('manage project')
            ...
            <a href="{{ route('projects.index') }}" class="btn bg-brown-subtitle text-white btn-sm" data-bs-toggle="tooltip" title="{{__('Back')}}">
