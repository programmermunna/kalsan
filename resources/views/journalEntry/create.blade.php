...
@section('content')
    ...
    {{ Form::open(array('url' => 'journal-entry','class'=>'w-100' , 'class'=>'needs-validation', 'novalidate')) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('description', '', array('class' => 'form-control','rows'=>'2' , 'placeholder'=>_('Enter Description'))) }}
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    @foreach ($subtypes as $subtypeId => $subtypeData)
                                                        ...
                                                        @foreach ($subtypeData['chart_of_accounts'] as $chartOfAccount)
                                                            ...
                                                            @foreach ($subtypeData['subAccounts'] as $subAccount)
                                                                ...
                                                                <option value="{{ $subAccount['id'] }}" class="ms-5"> &nbsp; &nbsp;&nbsp;&nbsp; {{' - '. $subAccount['account_name'] }}</option>Add commentMore actions
                                                                @endif
                                                            @endforeach
                                                        @endforeach
                                                    @endforeach
