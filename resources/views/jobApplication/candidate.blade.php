                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="action-btn  me-2">
                                            <a class="mx-3 btn btn-sm bg-primary align-items-center"  href="{{$resumes. '/' . $application->resume }}"  data-bs-toggle="tooltip"
                                               data-bs-original-title="{{ __('Download') }}"
                                               download><i class="ti ti-download text-white"></i></a>
                                        </span>
                                        <div class="action-btn">
                                            <a class="mx-3 btn bg-secondary btn-sm align-items-center" href="{{ $resumes . '/' . $application->resume }}" target="_blank"  >
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn ">
                                            ...
                                            <a class="mx-3 btn bg-warning btn-sm  align-items-center" data-bs-toggle="tooltip" title="{{__('View')}}" data-title="{{__('Details')}}" href="{{ route('job-application.show',\Crypt::encrypt($application->id)) }}"> <i class="ti ti-eye text-white"></i></a>
                                    </div>
                                            @endcan
                                    </td>
                                </tr>
