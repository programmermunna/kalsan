                            ...
                            @foreach ($jobOnBoards as $job)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge status_badge bg-success p-2 px-3 rounded">{{\App\Models\JobOnBoard::$status[$job->status]}}</span>
                                        @endif
                                    </td>
                                        ...
                                        <div class="action-btn  me-2">
                                            ...
                                            <div class="action-btn  me-2">
                                                <a href="{{ route('employee.show', \Crypt::encrypt($job->convert_to_employee)) }}"
                                                    class="mx-3 btn btn-sm bg-warning align-items-center" data-bs-toggle="tooltip"
                                                    title="{{ __('View') }}"
                                            ...
                                            <div class="action-btn me-2">
                                                ...
                                                <a href="#" class="mx-3 bg-danger btn btn-sm align-items-center bs-pass-para"
                                            ...
                                            <div class="action-btn me-2">
                                                <a href="{{ route('offerlatter.download.pdf', $job->id) }}"
                                                    class="mx-3 btn btn-sm bg-primary align-items-center "
