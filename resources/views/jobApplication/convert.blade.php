...
{{Form::open(array('route'=>array('job.on.board.converts',$jobOnBoard->id),'method'=>'post','enctype'=>'multipart/form-data' , 'class'=>'needs-validation', 'novalidate'))}}
    <div class="row">
    </div>
    <div class="row">
        <div class="col-md-6 ">
            <div class="card card-fluid">
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <x-Mobile label="{{__('Phone')}}" name="phone" required></x-Mobile>
                        </div>
