                    ...
                    <div class="card min-height-253">
                        ...
                        <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between ">
                            ...
                            @can('create allowance')
                                    <a href="#!" data-url="{{ route('allowances.create', $employee->id) }}" data-size="lg"
                                        ...
                                        <tbody>
                                            @foreach ($allowances as $allowance)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td>{{ $allowance->amount }}% (${{ $allowance->tota_allow }})
                                                        </td>
                                                    @endif
                                                    <td class="">
                                                        @can('edit allowance')
                    ...
                    <div class="card  min-height-253">
                        <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                            ...
                            @can('create commission')
                                    <a href="#!" data-url="{{ route('commissions.create', $employee->id) }}" data-size="lg"
                ...
                <div class="col-md-6">
                    <div class="card min-height-253">
                        <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                            ...
                            @can('create loan')
                                    <a href="#!" data-url="{{ route('loans.create', $employee->id) }}" data-size="lg"
                                        data-ajax-popup="true" data-title="{{ __('Create Loan') }}" data-bs-toggle="tooltip"
                                        title="{{ __('Create') }}" data-original-title="{{ __('Create Loan') }}"
                                        class="apply-btn btn btn-sm btn-primary">
                                        <i class="ti ti-plus"></i>
                                    </a>
                            @endcan
                        ...
                        <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                            ...
                            @can('create other payment')
                                <a href="#!" data-url="{{ route('otherpayments.create', $employee->id) }}"
                                    data-size="lg" data-ajax-popup="true" data-title="{{ __('Create Other Payment') }}"
                                    data-bs-toggle="tooltip" title="{{ __('Create') }}"
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                            ...
                            @can('create overtime')
                                <a href="#!" data-url="{{ route('overtimes.create', $employee->id) }}" data-size="lg"
