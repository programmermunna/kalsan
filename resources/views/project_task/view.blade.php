                        ...
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="action-btn">
                                    <a href="#" class="mx-3 bg-danger btn btn-sm  align-items-center delete-checklist" data-url="{{ route('checklist.destroy',[$task->project_id,$checklist->id]) }}">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto actions">
                                        <div class="action-btn me-2">
                                            <a href="{{asset(Storage::url('uploads/tasks/'.$file->file))}}" download class="mx-3 btn btn-sm align-items-center action-item bg-secondary" role="button" data-bs-toggle="tooltip" title="{{__('Download')}}">
                                                <i class="ti ti-download text-white"></i>
                                            </a>
                                        </div>
                                        @auth('web')
                                            <div class="action-btn">
                                                <a href="#" class="mx-3 bg-danger btn btn-sm  align-items-center delete-comment-file" data-url="{{ route('comment.destroy.file',[$task->project_id,$task->id,$file->id]) }}">
                                                    <i data-bs-toggle="tooltip" title="{{__('Delete')}}" class="ti ti-trash text-white"></i>
                                                </a>
                                            </div>
                                        @endauth
