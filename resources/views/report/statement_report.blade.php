...
@section('action-btn')
    <div class="float-end">
        <a href="{{route('accountstatement.export')}}" data-bs-toggle="tooltip" title="{{__('Export')}}" class="btn btn-sm btn-secondary me-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::date('end_date', $filter['endDateRange'], ['class' => 'endDate form-control']) }}  </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                      ...
                                      <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('type', $types, isset($filter['type']) ? strtolower($filter['type']) : '', array('class' => 'form-control select', 'placeholder' => __('Select Category'))) }}
                                        </div>
                                    </div>
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($reportData['sales'] as $index => $sale)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $name ?: __('N/A') }}</td>
                                    <td>{{ \Auth::user()->priceFormat($cr ?? 0) }}</td>
                                    <td>{{ \Auth::user()->priceFormat($dr ?? 0) }}</td>
                                    <td>{{ \Auth::user()->priceFormat(($cr ?? 0) - ($dr ?? 0)) }}</td>
                                </tr>
                             @endforeach
                            </tbody>
                        </table>
