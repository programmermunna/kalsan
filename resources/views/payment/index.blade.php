    ...
    $paymentpath = \App\Models\Utility::get_file('uploads/payment');
                                ...
                                @foreach ($payments as $index => $payment)
                                    <tr class="font-style">
                                        ...
                                        <td>{{ !empty($payment->bankAccount) ? $payment->bankAccount->bank_name : ''}}</td>
                                            ...
                                            <td class="action text-end">
                                               {{--  @can('edit payment')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 bg-info btn btn-sm align-items-center" data-url="{{ route('payment.edit', $payment->id) }}" data-ajax-popup="true" data-title="{{__('Edit Payment')}}" data-size="lg" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                                ...
                                                @can('delete payment')
                                                    <div class="action-btn bg-danger">
                                                        ...
                                                        <a href="#" class="mx-3  bg-danger btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" data-original-title="{{__('Delete')}}" title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$payment->id}}').submit();">
