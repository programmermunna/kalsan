    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="form-group">
                    ...
                    {{Form::select('tax_number', ['Vendor' => 'Vender', 'Other' => 'Other', 'Airline' => 'Airline'], old('title', $user->title ?? ''), ['class' => 'form-control', 'placeholder' => __('Select Company Type'), 'style' => 'width: 235px;']) }}
                </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
