                                                ...
                                                <td class="Action">
                                                    ...
                                                    @can('view lead')
                                                            ...
                                                            <div class="action-btn me-2">
                                                                <a href="{{route('leads.show',$lead->id)}}" class="mx-3 bg-warning btn btn-sm align-items-center"  data-size="xl" data-bs-toggle="tooltip" title="{{__('View')}}" data-title="{{__('Lead Detail')}}">
                                                        ...
                                                        @can('edit lead')
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="mx-3 bg-info btn btn-sm align-items-center" data-url="{{ route('leads.edit',$lead->id) }}" data-ajax-popup="true" data-size="xl" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-title="{{__('Lead Edit')}}">
